...
from send_mail import MailManager
...
class hackTickets(object):
    ...
    def confirmSeat(self):
        ...
        if self.driver.find_by_text(u"硬座余票<strong>0</strong>张") == None:          
            ...
            if self.noseat_allow == 0:
                ...
                #print(help(self.driver.find_by_id('2D')))
                #print(help(self.driver.find_by_id('qr_submit_id')))
                #self.driver.find_by_id('2D').first.click()
                # self.driver.find_by_id('1F')[0].click()
                #self.driver.find_by_text(u"D").last.click()

                self.driver.find_by_text(u"D")[1].click()
                self.driver.find_by_text(u"F")[1].click()
                self.driver.find_by_id('qr_submit_id').click()
    ...
    def start(self):
        ...
        # 初始化浏览器窗口大小
        self.driver.driver.set_window_size(1400, 900)
